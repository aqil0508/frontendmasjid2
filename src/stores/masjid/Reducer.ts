/* global IMasjid,_id,contactNo,address,latitude,longitude,createdAt,updatedAt,INewMasjid,IMasjidReducer,showAddForm,new,INewMasjid,masjids,error,loading */
import {
  ADD_NEW_MASJID,
  GET_All_MASJIDS,
  MASJID_ERROR,
